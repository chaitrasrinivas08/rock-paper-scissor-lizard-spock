...
let pentagonBoard = document.getElementById("pentagon");
...
const game = () => {
    ...
    //Play Match
    const playMatch = () => {
        const options = document.querySelectorAll('.pentagon button');

        const computerOptions = ['rock', 'scissors', 'paper','spock','lizard'];
        ...
        options.forEach((option) => {
            option.addEventListener('click', function () {
                //Change Board
                pentagonBoard.style.display = "none";
                ...
                pAgain.onclick = () => {
                    pentagonBoard.style.display = "block";
